...
#                 return jsonify({"message": f"Role harus {required_role}"}), 401
...
@penerima.post("/api/post/modal/personal")
...
@penerima.get('/api/get/account/donatur')
@jwt_required()
def getDonatur():
...
@penerima.get("/api/get/account/penerima")
@jwt_required()
def get_account():
    get_data = (
        db.session.query(
...
@penerima.delete("/api/delete/penerima/<int:id>")
@jwt_required()
def penerima_delete(id):
    try:
        ...
        print(e)
        return jsonify({"message": str(e)}), 500
@penerima.delete('/api/delete/donatur/<int:id>')
@jwt_required()
...
@penerima.put("/api/put/personalDataDiri/<int:id>")
@jwt_required()
...
@penerima.get('/api/get/role/user')
@jwt_required()
def get_role():
    try:
...
@penerima.put('/api/user/approved/<int:id>')
@jwt_required()
...
@penerima.put('/api/user/rejected/<int:id>')
@jwt_required()
